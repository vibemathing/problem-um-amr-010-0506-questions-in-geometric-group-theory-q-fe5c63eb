...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0506-questions-in-geometric-group-theory-q-fe5c63eb",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0506-8d7deed180fb",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0506"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Misha Kapovich) Is there ϵ > 0 so that δ(G) < ϵ implies that G is virtually free?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 5.6",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "8e0dafe02c3791179460f338eaf73ea4356c2435cbf6627868aa04f96453fcaa"
}
```
